              ...
              <div className="space-y-1.5">
                ...
                <div className="relative flex items-center">
                  ...
                  <button
                    ...
                    className="absolute right-3 p-2 text-outline hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 rounded-lg transition-colors"
